            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="input.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="nama">Nama :</label>
                            <input type="text" class="form-control" id="nama" name="nama" <?= $arrdat['nama'] ?> >
                        </div>
                        <div class="form-group">
                            <label for="alamat">Alamat :</label>
                            <input type="text" class="form-control" id="alamat" name="alamat" <?= $arrdat['alamat'] ?>>
                        </div>
                        <div class="form-group">
                            <label for="notelp">No Telepon :</label>
                            <input type="number" class="form-control" id="notelp" name="notelp" <?= $arrdat['notelp'] ?>>
                        </div>
